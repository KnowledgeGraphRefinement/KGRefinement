...
print(colored('\nThe shape of our Test features is:','green'), fullTestFeatures.shape)

print()
print(colored('\n     DESCRIPTIVE STATISTICS\n','yellow'))
print(colored(fullTestFeatures.describe(),'cyan'))
...
loaded_model_RFC = pickle.load(open('other/model_RFC', 'rb'))
pred1 = loaded_model_RFC.predict(fullTestFeatures)
result_RFC = loaded_model_RFC.score(fullTestFeatures, fullTestlabels)

loaded_model_SVC = pickle.load(open('other/model_SVC', 'rb'))
pred2 = loaded_model_SVC.predict(fullTestFeatures)
result_SVC = loaded_model_SVC.score(fullTestFeatures, fullTestlabels)

loaded_model_GPC = pickle.load(open('other/model_Gaussian', 'rb'))
pred3 = loaded_model_GPC.predict(fullTestFeatures)
result_GPC = loaded_model_GPC.score(fullTestFeatures, fullTestlabels)

loaded_model_SGD = pickle.load(open('other/model_SGD', 'rb'))
pred4 = loaded_model_SGD.predict(fullTestFeatures)
result_SGD = loaded_model_SGD.score(fullTestFeatures, fullTestlabels)
...
for i in range(len(fullTestlabels)):
    if(pred4[i] == 1):
        ...
        counti += 1
print("Precision, Recall & F1: ", precision_recall_fscore_support(fullTestlabels, pred4, average='weighted'))